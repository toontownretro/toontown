"""
TTSCSellbotNerfMenu.py: contains the TTSCSellbotNerfMenu class
"""
...
SellbotNerfMenu = [
    ...
    (OTPLocalizer.SellbotNerfMenuSections[1],
        [30157, 30158, 30159, 30160, 30161, 30162, 30163, 30164]),            # GROUPING
    (OTPLocalizer.SellbotNerfMenuSections[2],
        [30165, 30166, 30167, 30168, 30169, 30170, 30171, 30172, 30173, 30174, 30175]),            # SELLBOT TOWER/VP
    ]

class TTSCSellbotNerfMenu(SCMenu):
    """
    Speedchat phrases for Sellbot Nerf
    """
    def __init__(self):
