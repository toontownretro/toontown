...
class MazeMapGui(DirectFrame):
    ...
    def __init__(self, mazeCollTable, maskResolution=None, radiusRatio=None,
                 bgColor = (0.8, 0.8, 0.8), fgColor = (0.5, 0.5, 0.5, 1.0)):
        """
        Constructor for a MazeMap.  the mazeCollTable parameter is a 2d array of
    ...
    def updateToon(self, toon, tX, tY):
        if not self._toon2marker.has_key(toon): return
