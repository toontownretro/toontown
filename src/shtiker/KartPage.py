...
class ItemSelector( DirectFrame ):
    ...
    class ItemViewer( DirectFrame ):
        ...
        def load( self, uiRootNode ):
            ...
            tex = loader.loadTexture( "phase_6/maps/NoAccessoryIcon3.tga" )
        ...
        def __handleShowItem( self ):
            ...
            if( self.currAccessoryType in [ KartDNA.ebType, KartDNA.spType, KartDNA.fwwType, KartDNA.bwwType ] ):
                ...
                tex = loader.loadTexture( "phase_6/maps/%s.tga" % ( texNodePath ) )
                #if( tex is None ):
                #    tex = loader.loadTexture( "phase_4/maps/robber-baron.tga" )
                ...
                tex = loader.loadTexture( "phase_6/maps/Kartmenu_paintbucket.tga" )
                ...
                tex = loader.loadTexture( "phase_6/maps/%s.tga" % (texNodePath) % ( kartDecal ) )
            else:
                tex = loader.loadTexture( "phase_6/maps/NoAccessoryIcon3.tga" )
        ...
        def __handleHideItem( self ):
            ...
            """
            self.uiImagePlane.component( 'geom0' ).setColorScale( 1.0, 1.0, 1.0, 1.0 )
            self.uiImagePlane.component( 'geom0' ).setTexture( loader.loadTexture( 'phase_6/maps/NoAccessoryIcon3.tga' ), self.texCount )
            #self.uiImagePlane.component('geom0').setColorScale( 1.0, 1.0, 0.8, 1.0 )
