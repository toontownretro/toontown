...
GM_3 = "RESISTANCE RANGER" # "RÉSISTANCE DES TOONS"
GM_4 = "GC"
...
sleep_auto_reply = "%s dort en ce moment."
...
QuestDialogDict = {
    ...
    1060 : { QUEST : "Merci d'être passé par ici !\aCes Cogs ont volé mon encre je n'en ai presque plus.\aPourrais-tu me pêcher de l'encre de seiche dans la mare ?\aTu n'as qu'à rester sur un ponton près de la mare pour pêcher.",
             LEAVING : "",
    ...
    1067 : { QUEST : "C'est ça, très bien !\aOh, l'adresse est toute tachée...\aTout ce que j'arrive à lire, c'est Docteur... - le reste est brouillé.\aC'est peut-être pour _toNpcName_ ? Peux-tu lui porter ?_where_",
             LEAVING : "" },
    ...
    5310 : { GREETING : "",
             ...
             QUEST : "Merci. Je me sens un peu mieux.\aMais il y a autre chose...\aEst-ce que tu pourrais passer chez _toNpcName_ pour me trouver un alibi ?_where_"  },
    ...
    6242 : { GREETING : "",
             ...
             INCOMPLETE_PROGRESS : "Quatre cent quarante-deux... quatre cent quarante-trois...\aQuoi ? Tu es déjà de retour ? Mais il y a toujours trop de bruit !\aAh non, j'ai encore perdu le compte.\aUn...deux...trois...",
    ...
    6265 : { GREETING : "",
             ...
             INCOMPLETE_PROGRESS : "Si tu ne livres pas ce costume zazou à Bébé MacDougal,\ail va être tout froissé.",
             },
    6266 : { GREETING : "",
             LEAVING : "",
...
ReportPanelConfirmations = (
    ...
    "Tu es sur le point de signaler que %s a piraté/modifié le jeu ou utilisé un logiciel tiers.",
    )
...
ChipChatter = (
        ...
        [ # Goodbyes
        "Nous allons dans " + lTheBrrrgh +" pour jouer avec %s." % Pluto,
...
# EventsPage.py
PartyDateFormat = "%(dd)d %(mm)s %(yyyy).4d" # 8 Dec 2008
...
# NewsPage.py
NewsPageName = "News"
NewsPageImportError = 'Whoops! There is an issue\nloading the "Toon News ... for the Amused!" Please check back later.'
...
NewsPageErrorDownloadingFile = 'Whoops! Page %s\nis missing from "Toon News ... for the Amused!" Please check back later.'
...
PartyCatchActivityExit        = 'SORTIE'
PartyCatchActivityApples      = 'pommes'
PartyCatchActivityOranges     = 'oranges'
PartyCatchActivityPears       = 'poires'
PartyCatchActivityCoconuts    = 'noix de coco'
PartyCatchActivityWatermelons = 'pastèques'
PartyCatchActivityPineapples  = 'ananas'
PartyCatchActivityAnvils      = 'enclumes'
...
OptionsPageWhisperEnabledLabel = "Autoriser les chuchotements de tout le monde."
OptionsPageWhisperDisabledLabel = "Autoriser les chuchotements uniquement des amis."
OptionsPageSpeedChatStyleLabel = "Couleur du Chat rapide"
OptionsPageDisplayWindowed = "dans une fenêtre"
OptionsPageDisplayEmbedded = "Dans le navigateur"
...
FurnitureNames = {
  ...
  1350 : "Tirelire de 12000 bonbons",
  1399 : "Téléphone",
  1400 : "Toon Cézanne",
  1410 : "Fleurs",
...
zone2TitleDict = {
    ...
    9756 : ("Quartier général des Toons", ""),
...
FireworksValentinesBeginning = lToonHQ+" : Joyeuse Saint Valentin à tous les amoureux !" # Brazil
...
FlowerUnknown = "????"
FloweringNewEntry = "Nouvelle entrée"
ShovelNameDict = {
    0 : "Étain",
    1 : "Bronze",
    2 : "Argent",
...
TravelGameConvertingVotesToBeans = "Converting some votes to jellybeans..." # Fix
...
ElevatorBossBotBoss = "Combat Directeur Général"
ElevatorBossBotCourse = "Parcour de Golf Cog"
ElevatorBossBotCourse0 = "Les trois premiers à l'avant"
ElevatorBossBotCourse1 = "Les six du milieu"
ElevatorBossBotCourse2 = "Les neuf du fond"
ElevatorCashBotBoss = "Combat Directeur Financier"
ElevatorCashBotMint0 = "Fabrique à Sous"
ElevatorCashBotMint1 = "Fabrique à Euros"
ElevatorCashBotMint2 = "Fabrique à Lingots"
ElevatorSellBotBoss = "Combat Vice-Président"
ElevatorSellBotFactory0 = "Entrée principale"
ElevatorSellBotFactory1 = "Entrée latérale"
ElevatorLawBotBoss = "Combat Juge"
ElevatorLawBotCourse0 = "Bureau Loibot A"
ElevatorLawBotCourse1 = "Bureau Loibot B"
ElevatorLawBotCourse2 = "Bureau Loibot C"
ElevatorLawBotCourse3 = "Bureau Loibot D"
...
ChineseCheckersGetUpButton = "Se lever"
...
AwardNotifyNewItems = "Tu as reçu une récompense dans ta boîte aux lettres !"
AwardNotifyOldItems = "Des récompenses t'attendent encore dans ta boîte aux lettres !"

# MailboxScreen.py
InviteInvitation = "l'invitation"
...
InviteRejectAllOk = "L'hôte a été informé que tu as refusé l'invitation."
...
DayNamesAbbrev = ("LUN", "MAR", "MER", "JEU", "VEN", "SAM", "DIM")
