...
def openToAll(zoneId, avatar):
    ...
    elif ToontownGlobals.LAWBOT_NERF_HOLIDAY in simbase.air.holidayManager.currentHolidays:
...
# Determine if we're in a zone that players can wear suits
