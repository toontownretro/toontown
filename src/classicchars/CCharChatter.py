...
def getChatter( charName, chatterType ):
    if charName==TTLocalizer.Mickey:
        ...
        elif chatterType == ToontownGlobals.WINTER_DECORATIONS or \
             chatterType == ToontownGlobals.WINTER_CAROLING or \
             chatterType == ToontownGlobals.WACKY_WINTER_DECORATIONS or \
             chatterType == ToontownGlobals.WACKY_WINTER_CAROLING:
