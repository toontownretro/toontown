...
PUBLISHED:
  ...
  int get_block_number_at(uint32_t index) const;
  ...
  int get_door_pos_hpr_block_at(uint32_t index) const;
  ...
  int get_sign_transform_block_at(uint32_t index) const;
  ...
  int get_title_block_at(uint32_t index) const;
  ...
  PT(DNAVisGroup) get_DNAVisGroup(uint32_t i) const;
  int get_num_visibles_in_DNAVisGroup(uint32_t i) const;
  string get_DNAVisGroup_name(uint32_t i) const;
  string get_visible_name(uint32_t visgroup_index, uint32_t visible_index) const;
  ...
  INLINE PT(DNAVisGroup) get_DNAVisGroupAI(uint32_t i) const;
  INLINE void reset_DNAVisGroupsAI();

  // Node relation functions
  INLINE int get_num_PandaNodes() const;
  PT(PandaNode) get_PandaNode_at(uint32_t i) const;
