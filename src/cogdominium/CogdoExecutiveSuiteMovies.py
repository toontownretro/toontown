...
class CogdoExecutiveSuiteIntro(CogdoGameMovie):
    ...
    def load(self):
        ...
        self.toonDNA.newToonFromProperties('dss', 'ss', 'm', 'm',
                                           2, 0, 2, 2,
                                           1, 8, 1, 8, 1, 14)
        ...
        self._ival = Sequence(
            ...
            Func(showShopOwner),
            ParallelEndTogether(camera.posInterval(self.cameraMoveDuration, Point3(8, 0, 13), blendType='easeInOut'),
                                camera.hprInterval(0.5, self._camHelperNode.getHpr(), blendType='easeInOut')),
    ...
    def _setCamTarget(self, targetNP, distance, offset=Point3(0, 0, 0), angle=Point3(0, 0, 0)):
        ...
        self._camHelperNode.setHpr(self._camTarget,
