...
class CogdoFlyingLevel(DirectObject):
    ...
    def _initStartEndPlatforms(self):
        self.startPlatform = CogdoFlyingPlatform(self._startPlatformModel,
                                                 Globals.Level.PlatformTypes.StartPlatform,
                                                 )
        self.endPlatform = CogdoFlyingPlatform(self._endPlatformModel,
...
class CogdoFlyingLevelFactory:
    ...
    def loadAndBuildLevel(self, safezoneId):
        ...
        levelNode.hide()
        self._level = CogdoFlyingLevel(self._parent,
                                       levelNode,
                                       startPlatformModel,
                                       endPlatformModel,
