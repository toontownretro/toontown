...
class CogdoFlyingPlayer(FSM):
    ...
    def initIntervals(self):
        ...
        self.pulseBubbleSeq = Parallel(
            Sequence(
                LerpFunctionInterval(
                    ...
                    fromData=scale, toData=scale * 1.1,
                    duration=pulseTime / 2.0,
                    blendType='easeInOut',
                ),
                LerpFunctionInterval(
                    self.redTapeRing.setScale,
                    fromData=scale * 1.1, toData=scale,
                    duration=pulseTime / 2.0,
                    blendType='easeInOut',
                ),
            ),
        ...
        self.popUpBubbleSeq = Sequence(
            ...
            LerpScaleInterval(self.redTapeRing, scaleBounceTime, scale, startScale=scale * bouncePercent, blendType='easeInOut'),
        ...
        self.removeBubbleSeq = Sequence(
            ...
            LerpScaleInterval(self.redTapeRing, scaleTime, 0.0, startScale=scale * bouncePercent, blendType='easeInOut'),
