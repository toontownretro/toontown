...
class DistCogdoGame(DistCogdoGameBase, DistributedObject):
    ...
    def __init__(self, cr):
        ...
        self._stashElevatorFC = FunctionCall(self._doStashElevator,
            self._toonsInEntranceElev, self._gotInterior, self._wantStashElevator)
    ...
    def _requestInterior(self):
        self.cr.relatedObjectMgr.requestObjects([self._interiorId],
                                                allCallback=self._handleGotInterior)
