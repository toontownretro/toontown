...
class CogdoFlyingGatherableBase:
    ...
    def initFlash(self):
        ...
        self.ts.setSort(1)
        self.ts.setCombineRgb(TextureStage.CMInterpolate, TextureStage.CSPrevious,
                              TextureStage.COSrcColor, TextureStage.CSTexture,
                              TextureStage.COSrcColor, TextureStage.CSConstant,
                              TextureStage.COSrcColor)
        self.ts.setCombineAlpha(TextureStage.CMInterpolate, TextureStage.CSPrevious,
        ...
        self.flashLoop = Sequence(
                            LerpFunctionInterval(
                                ...
                                fromData=1.0, toData=0.25,
                                duration=dur / 2.0,
                                blendType='easeInOut',
                                ),
                            LerpFunctionInterval(
                                self.setTextureAlphaFunc,
                                fromData=0.25, toData=1.0,
                                duration=dur / 2.0,
                                blendType='easeInOut',
                                ),
                            Wait(1.0),
...
class CogdoFlyingMemo(CogdoFlyingGatherableBase, CogdoMemo):
    ...
    def __init__(self, serialNum, model):
        CogdoMemo.__init__(self, serialNum,
...
class CogdoFlyingPowerup(CogdoFlyingGatherable):
    ...
    def __init__(self, serialNum, powerupType, model):
        ...
        CogdoFlyingGatherable.__init__(self,
                                       powerupType,
                                       serialNum, model, Globals.Gameplay.MemoCollisionRadius)
...
class CogdoFlyingPropeller(CogdoFlyingGatherable):
    def __init__(self, serialNum, model):
        CogdoFlyingGatherable.__init__(self,
                                       ...
                                       serialNum, model, Globals.Gameplay.PropellerCollisionRadius, animate=False)
