...
class CogdoFlyingLocalPlayer(CogdoFlyingPlayer):
    ...
    def initLocalPlayerIntervals(self):
        ...
        self.waitingForWinSeq = Sequence(
                                    ...
                                    Wait(2.0),
                                    Func(self.game.distGame.d_sendRequestAction, Globals.AI.GameActions.LandOnWinPlatform, 0),
        ...
        self.winInterval = Sequence(
                            ...
                            Wait(4.0),
                            Func(self.game.distGame.d_sendRequestAction, Globals.AI.GameActions.WinStateFinished, 0),
    ...
    def startHitByWhirlwindInterval(self):
        ...
        def spinPlayer(t):
            ...
            self.toon.setPos(
                self.activeWhirlwind.model.getX(self.game.level.root) + math.cos(angle) * 2,
