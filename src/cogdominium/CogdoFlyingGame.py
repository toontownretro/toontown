...
class CogdoFlyingGame(DirectObject):
    ...
    def _addPlayer(self, player):
        ...
        self.accept(toon.uniqueName('disable'),
            self._removePlayer, extraArgs=[toon.doId])
    ...
    def handleLocalToonEnterGatherable(self, gatherable):
        ...
        if gatherable.wasPickedUp():return
        if gatherable.isPowerUp() and gatherable.wasPickedUpByToon(self.localPlayer.toon):return
