...
class CatalogAccessoryItem(CatalogItem.CatalogItem):
    ...
    def reachedPurchaseLimit(self, avatar):
        ...
        if self.isHat():
            ...
            # Check if the hat is in the avatar's trunk.
            l = avatar.hatList
            ...
            # Check if the glasses are in the avatar's trunk.
            ...
            # Check if the backpack is in the avatar's trunk.
            ...
            # Check if the shoes are in the avatar's trunk.
            l = avatar.shoesList
            for i in range(0, len(l), 3):
                if (l[i] == defn[0] and
                    l[i + 1] == defn[1] and
    ...
    def recordPurchase(self, avatar, optional):
        ...
        # Save the avatar's current accessories in his trunk.
        if self.isHat():
            defn = ToonDNA.HatStyles[str]
...
def getAllAccessories(*accessoryTypes):
    ...
    # CatalogAccessoryItems (that is, all color variants) for the
