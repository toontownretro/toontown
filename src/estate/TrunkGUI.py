...
class TrunkGUI(StateData.StateData):
    ...
    def __init__(self, isOwner,
                 doneEvent, cancelEvent,
                 swapHatEvent, swapGlassesEvent, swapBackpackEvent, swapShoesEvent,
                 deleteEvent,
                 hatList = None, glassesList = None, backpackList = None, shoesList = None):
    ...
    def load(self):
        ...
        self.hatLButton = addButton(self.hatFrame,
                                    halfButtonScale,
        ...
        self.hatRButton = addButton(self.hatFrame,
        ...
        self.glassesLButton = addButton(self.glassesFrame,
                                        halfButtonScale,
                                        halfButtonHoverScale,
                                        -0.2,
                                        self.swapGlasses,
        ...
        self.glassesRButton = addButton(self.glassesFrame,
                                        halfButtonInvertScale,
                                        halfButtonInvertHoverScale,
                                        0.2,
                                        self.swapGlasses,
        ...
        self.backpackLButton = addButton(self.backpackFrame,
                                         halfButtonScale,
                                         halfButtonHoverScale,
                                         -0.2,
                                         self.swapBackpack,
        ...
        self.backpackRButton = addButton(self.backpackFrame,
                                         halfButtonInvertScale,
                                         halfButtonInvertHoverScale,
                                         0.2,
                                         self.swapBackpack,
        ...
        self.shoesLButton = addButton(self.shoesFrame,
                                      halfButtonScale,
                                      halfButtonHoverScale,
                                      -0.2,
                                      self.swapShoes,
        ...
        self.shoesRButton = addButton(self.shoesFrame,
                                      halfButtonInvertScale,
                                      halfButtonInvertHoverScale,
                                      0.2,
                                      self.swapShoes,
    ...
    def swapHat(self, offset):
        ...
        self.updateScrollButtons(self.hatChoice, length, 0,
                                 self.hatLButton, self.hatRButton)

        if ((self.hatChoice < 0) or (self.hatChoice >= len(self.hats))
        ...
        assert(self.notify.debug("hatChoice: %s" % (self.hatChoice)))
    ...
    def swapGlasses(self, offset):
        ...
        if ((self.glassesChoice < 0) or (self.glassesChoice >= len(self.glasses))
        ...
        assert(self.notify.debug("glassesChoice: %s" % (self.glassesChoice)))
    ...
    def swapBackpack(self, offset):
        ...
        if ((self.backpackChoice < 0) or (self.backpackChoice >= len(self.backpacks))
        ...
        assert(self.notify.debug("backpackChoice: %s" % (self.backpackChoice)))
    ...
    def swapShoes(self, offset):
        ...
        if ((self.shoesChoice < 0) or (self.shoesChoice >= len(self.shoes))
        ...
        assert(self.notify.debug("shoesChoice: %s" % (self.shoesChoice)))
    ...
    def getCurrToonSetting(self):
        ...
        """     
        return [self.hats[self.hatChoice], self.glasses[self.glassesChoice], self.backpacks[self.backpackChoice], self.shoes[self.shoesChoice]]
