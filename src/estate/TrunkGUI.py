...
class TrunkGUI(StateData.StateData):
    # Trunk class: contains methods for cycling through and
    # selecting accessories from a toons trunk
    # (not necessarily one's own trunk)
    notify = directNotify.newCategory("TrunkGUI")

    def __init__(self, isOwner,
                 doneEvent, cancelEvent,
                 swapHatEvent, swapGlassesEvent,
                 swapBackpackEvent, swapShoesEvent,
                 deleteEvent,
                 hatList = None, glassesList = None,
                 backpackList = None, shoesList = None):
    ...
    def load(self):
        ...
        def addFrame(posZ, text):
            return DirectFrame(parent=self.parentFrame,
                                      image=shuffleFrame,
        ...
        self.cancelButton = DirectButton(relief=None,
        ...
        self.rotateR = DirectButton(relief=None,
                                    pos=(0.15, 0, 0.85),
                                    image=(guiArrowRotateUp,
                                           guiArrowRotateDown,
                                           guiArrowRotateUp,
        ...
        if self.isOwner:
            ...
            self.trashPanel = DirectFrame(parent=aspect2d,
            ...
            self.button = DirectButton(relief=None,
    ...
    def setupScrollInterface(self):
        ...
        # set up the accessories lists for the scrollInterface
        self.hats = []
        self.glasses = []
        self.backpacks = []
        self.shoes = []
        # stick our current accessories in the list
        ...
        # stick hat, glasses, backpack and shoes into the correct format
        i = 0
        ...
        # our current accessories are index=0 in the hat, glasses, backpack and shoes lists
        self.hatChoice = 0
        self.glassesChoice = 0
        self.backpackChoice = 0
        self.shoesChoice = 0
        # set texture to start of accessory choices
        self.swapHat(0)
        self.swapGlasses(0)
        self.swapBackpack(0)
        self.swapShoes(0)
    ...
    def updateScrollButtons(self, choice, length,
                            startTex, lButton, rButton):
        if choice >= length - 1:
